  ...
  return (
    <>
      <SEO>
        ...
        <meta
          name="description"
          content="Контакты Theatrum — частный универсальный гастрольный театр. Верхняя Пышма, Александра Козицына, 2"
        />
      ...
      <chakra.main mt={20}>
        {openedFeedbackModal && (
          <FeedbackModal
            isOpened={openedFeedbackModal}
            onClose={() => setOpenedFeedbackModal(false)}
          />
        )}
        <chakra.section
          pt={10}
        ...
        >
          ...
          >
            ...
            <Heading mt={10} as="h2" fontSize="3xl" fontWeight="medium">
              Схема проезда
            </Heading>
            ...
            {isNotVoid(image.data) && (
              <>
                <Text mt={6}>
                  ...
                  <chakra.span color="brand.200">отдельном окне</chakra.span>
                </Text>
                <chakra.div
                  ...
                  mt={2}
                >
                  <Link href={image.data.attributes.url} target="_blank">
                    <Image
