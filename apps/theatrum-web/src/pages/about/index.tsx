  ...
  return (
    <>
      <SEO>
        ...
        <meta
          name="description"
          content="Theatrum - частный универсальный театр, первая в Верхней Пышме профессиональная сценическая площадка. THEATRUM уникален универсальностью и высокой технологичностью, благодаря чему здесь возможна самая разнообразная палитра мероприятий: от драматических постановок до оперных спектаклей."
        />
      ...
      <chakra.main mt={20} bgColor="brand.100">
        ...
        >
          ...
          >
            ...
            >
              <Image
                src="/letters-theatrum-about.png"
                fill
                alt="Три буквы THR"
            ...
            <Flex w="container.md" h="auto" zIndex={2}>
              ...
              >
                ...
                — частный универсальный театр, первая в Верхней Пышме
                профессиональная сценическая площадка. THEATRUM уникален
                универсальностью и высокой технологичностью, благодаря чему
                здесь возможна самая разнообразная палитра мероприятий: от
                драматических постановок до оперных спектаклей.
              </Text>
            </Flex>
          </Container>
        </chakra.section>
                ...
                >
                  ...
                  >
                    ...
                    {block.button === "table_booking" && (
                      <Link
                        href="https://cateringprime.ru/teatrum"
                        target="_blank"
                      >
                        <Button
                          size="lg"
            ...
            <Flex mt={10} gap={10} flexWrap="wrap">
              {scenes.map((scene, index) => (
                ...
                >
                  <chakra.div
                    w="100%"
                    h={["260px", "220px", "220px", "220px", "220px"]}
                    pos="relative"
                  >
                    <Image
                  ...
                  <Text color="brand.300" noOfLines={3} fontSize="md">
                    {scene.description}
                  </Text>
                  <Button
                    size="md"
                ...
                >
                  ...
                  >
                    ...
                    <Flex flexDir="column" gap={2}>
                      <Text color="inherit" lineHeight={1.2} noOfLines={2}>
                        {document.name}
                      </Text>
                      <Text color="brand.300" lineHeight={1} fontSize="md">
                        {(document.file.data.attributes.size / 1024).toFixed(2)}{" "}
                        мб
                      </Text>
                    </Flex>
                  </Flex>
